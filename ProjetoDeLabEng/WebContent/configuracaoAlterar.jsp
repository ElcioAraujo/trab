...
<%@page import="br.av.model.Usuario"%>
<%@page import="br.av.persistence.UsuarioDaoImpl"%>
<%@page import="br.av.persistence.UsuarioDao"%>
...
<body>
						...
						<ul class="nav pull-right">
							<li class="dropdown" style="padding-left: 125px;"><a
								...
								<ul class="dropdown-menu">
									<li><a href="./UsuarioController">Configurações</a></li>
									<li class="divider"></li>
	...
	<div class="success"><img src="bootstrap/img/success.png" width="35px" height="35px"> Dados Atualizados com Sucesso! </div>
		...
		<form method="post" action="./UsuarioController">
			...
			<% 
				...
				Usuario u = uDao.pesquisaDadosUsuario(usuario);
			%>
				Email :<input type="email" placeholder="mail@example.com" style="width: 50%;" name="email" value="<%= u.getEmail() %>"><br />
				Nova Senha :<input type="password" placeholder="Digite a nova senha" name="senha" value="<%= u.getSenha() %>"><br />
			</div>
			<button type="submit" class=" btn btn-success direita btn-large"
				name="btnAlterar" style="margin-right: 30%;" value="Alterar">Alterar</button>
		</form>
		<!--./FormulÃ¡rio-->
